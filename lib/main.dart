...
class tarefa {
  ...
  tarefa({required this.titulo, this.concluida = false}); // Construttor
  Map<String, dynamic> paraMapa() => {
        'titulo': titulo,
        'concluida': concluida
        };
  
  factory tarefa.deMapa(Map<String, dynamic> map) => tarefa(
      titulo: map['titulo'],
...
class _TelaListaState extends State<TelaLista> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Lista de Tarefas Persistente'),
      ),
      body: Column(
        children: [
          Padding( 
